...
def gru_layer(tparams, state_below, options, prefix='gru', mask=None, **kwargs):
	...
	rval, updates = theano.scan(_step,sequences=seqs,outputs_info = [tensor.alloc(0., n_samples, dim)],non_sequences = [tparams[_p(prefix, 'U')],tparams[_p(prefix, 'Ux')]],name=_p(prefix, '_layers'),
